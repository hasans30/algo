...
namespace DSandAlgo
{
    class LowestCommonAncestor
    {
        ...
        public static void CallLCAHelper()
        {
            ...
            TreeNode e = new TreeNode(); e.val = 3; a.right = e; e.left = e.right = null;
            /*
             *                 10        
             *            -2 (root)   
             *      2 (a)         4(b)
            ...
            */
            ...
            TreeNode tn=LCAHelper(parRoot, 3,4);
            Console.WriteLine(tn.val);

        }
        public static TreeNode LCAHelper(TreeNode tn, int p, int q)
        {
            if (tn == null) return null;
            if (tn.val == p || tn.val == q) return tn;
            ...
            return LCAHelper(childside, p, q);
